                ...
                switch (Integer.parseInt(bufferedReader.readLine())) {
                    case 1:
                        ...
                        while (inputPatientLoop > 0) {
                            ...
                            System.out.println(personDirectory.getPersonList().size());
                        }
                        break;
                    case 2:
                    ...
                    case 5:
                        ...
                        {
                            if (patient.isThisVitalSignNormal(communityPatient) == false){
                                communityCount += 1;
                                communityMap.put(patient.getCommunity().getCommunityName(),communityCount);
                            }
                        }
                        TreeMap sortedCommunity = new TreeMap<>(communityMap);
                        System.out.println("Community and the count" + sortedCommunity);
                        break;
                    default:
                        break;
                }
